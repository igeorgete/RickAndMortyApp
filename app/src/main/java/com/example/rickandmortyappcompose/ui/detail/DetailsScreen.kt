...
import com.example.rickandmortyappcompose.ui.detail.components.CharacterImage
import com.example.rickandmortyappcompose.ui.detail.components.DetailProperty
import com.example.rickandmortyappcompose.ui.detail.components.mirroringBackIcon
...
private fun Body(character: Character?) {
    Column(
        ...
        DetailProperty(label = stringResource(R.string.first_location), value = character?.origin?.name, imageVector = Icons.Outlined.LocationOn)
